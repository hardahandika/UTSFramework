	...
	<body>
		<div class="container-fluid">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<h1>Daftar Pemain</h1>	
						<a href="<?php echo site_url('/pemain/create/').$this->uri->segment(3) ?>"><button type="button" class="btn btn-default"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Masukkan data pemain baru</button></a>
							...
							<table class="table table-hover" id="example">
								...
								<?php foreach ($pemain_list as $key) { ?>
									<tr>
										...
										<td>
											<a href="<?php echo site_url('pemain/update/').$key->id ?>" type="button" class="btn btn-warning"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span> Update</a>
											<a href="<?php echo site_url('pemain/delete/').$key->id ?>" onclick="return konfirmasi()" type="button" class="btn btn-danger"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span> Delete</a>
										</td>
									</tr>
									<?php } ?>
								</tbody>
